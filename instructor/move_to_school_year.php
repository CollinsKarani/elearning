					...
					<div class="modal-body">
										...
										<div class="control-group">
                                          ...
                                          <div class="controls">
                                            ...
                                            <option></option>
											<?php
											$query1 = $conn->query("select * from teacher_class where class_id ='$class_id' and school_year = '$school_year'");
										...
										<div class="control-group">
                                          ...
                                          <div class="controls">
                                            <select name="teacher_id1"  class="" required>
                                             	<option></option>
											<?php
											$query = $conn->query("select * from teacher order by firstname");
