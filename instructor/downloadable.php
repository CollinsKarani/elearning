<?php
 ...
 include('../inc/lecturer_header.php'); ?>
<?php $get_id = $_GET['id']; ?>
    <body>
                        ...
                        <div id="block_bg" class="block">
							...
							Check All <input type="checkbox"  name="selectAll" id="checkAll" />
								...
								$("#checkAll").click(function () {
									...
									<?php
										$query = $conn->query("select * FROM files where class_id = '$get_id'  order by fdatein DESC ");
  								...
  								<form action="copy_file.php" method="post">
									...
									<?php include('move_to_school_year.php'); ?>
                              		...
                              		<?php
										$query =$conn->query("select * FROM files where class_id = '$get_id'  order by fdatein DESC ")or die(mysql_error());
