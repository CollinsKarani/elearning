            ...
            <div class="row-fluid">
                ...
                <div class="span9" id="content">
					...
					<button name="backup_delete" class="btn btn-danger"><i class="icon-check icon-large"></i> Yes</button>
										...
										<tbody>
                              		<?php
										$query = $conn->query("select * FROM quiz where teacher_id = '$session_id'  order by date_added DESC ")or die(mysql_error());
										...
										<td width="30">
                                         ...
                                         <td width="60">
                                             ...
                                             <a href="edit_quiz.php<?php echo '?id='.$id; ?>" class="btn btn-success"><i class="icon-pencil"></i></a>
                                                <a href="open_quiz.php<?php echo '?id='.$id; ?>" class="btn btn-info"><i class="icon-ok"></i>Open</a>
