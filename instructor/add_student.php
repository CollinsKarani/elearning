                        ...
                        <div id="block_bg" class="block">
						 ...
						 <thead>
                            ...
                            <tbody>
										...
										$a = 0 ;
										$query = $conn->query("select * from student LEFT JOIN class on class.class_id = student.class_id
...
if (isset($_POST['submit'])){
	...
	$Add = $_POST[$test4];
 	...
 	$query = $conn->query("select * from teacher_class_student where student_id = '$id' and teacher_class_id = '$class_id' ")or die(mysql_error());
	...
	if($Add == 'Add'){
	$conn->query("insert into teacher_class_student (student_id,teacher_class_id,teacher_id) values('$id','$class_id','$teacher_id') ");
