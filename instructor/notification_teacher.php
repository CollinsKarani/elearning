        ...
        <div class="container-fluid">
            <div class="row-fluid">
                ...
                <div class="span9" id="content">
					...
					<?php $query = $conn->query("select * from teacher_notification
					...
					$query_yes_read = $conn->query("select * from notification_read_teacher where notification_id = '$id' and teacher_id = '$session_id'");
