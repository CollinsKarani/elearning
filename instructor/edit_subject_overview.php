					  ...
					  <!-- breadcrumb -->
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
								<?php 
								$subject_query = $conn->query("select * from class_subject_overview where  class_subject_overview_id  = '$subject_id'");
								...
								?>
										...
										$conn->query("update class_subject_overview set content = '$content' where class_subject_overview_id = '$subject_id'")or die(mysql_error());
										?>
										<script>
