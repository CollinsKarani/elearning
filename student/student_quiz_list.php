                ...
                <div class="span9" id="content">
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
							...
							<?php 		$query =$conn->query("select * FROM class_quiz
                                ...
                                <div class="span12">
									...
									<?php include('copy_to_backpack_modal.php'); ?>
                              		...
                              		<?php
										...
										LEFT JOIN quiz on class_quiz.quiz_id = quiz.quiz_id
										where (teacher_class_id = '$get_id' AND class_quiz.status =1)  order by class_quiz_id DESC ");
										while($row = mysqli_fetch_array($query)){
										$id  = $row['class_quiz_id'];
										$quiz_id  = $row['quiz_id'];
										$quiz_time  = $row['quiz_time'];
									
										$query1 = $conn->query("select * from student_class_quiz where class_quiz_id = '$id' and student_id = '$session_id'");
