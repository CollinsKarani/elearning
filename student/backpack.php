<?php require_once('../inc/header_dashboard.php'); ?>
<body>
                     ...
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
							...
							<div class="pull-right">
								...
								<?php
								$query_backpack = $conn->query("select * FROM student_backpack where student_id = '$session_id'  order by fdatein DESC ");
								...
								?>
									...
									<?php include('modal_backpack_delete.php'); ?>
										...
										<tbody>
                              		<?php
										$query =$conn->query("select * FROM student_backpack where student_id = '$session_id'  order by fdatein DESC ");
