							...
							Check All <input type="checkbox"  name="selectAll" id="checkAll" />
								...
								$("#checkAll").click(function () {
									$('input:checkbox').not(this).prop('checked', this.checked);
										...
										<li class="active"><a href="student_message"><i class="icon-envelope-alt"></i>inbox</a></li>
										<li class=""><a href="sent_message_student"><i class="icon-envelope-alt"></i>Send messages</a></li>
										</ul>
	...
	$(document).ready( function() {
		...
		var id = $(this).attr("id");
			...
			return false;
				...
				<?php require_once('create_message_student_student.php') ?>
            </div>
