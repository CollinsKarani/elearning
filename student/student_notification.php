...
require_once('../inc/header_student.php'); ?>
    <body>
		<?php require_once('navbar_student.php'); ?>
            ...
            <div class="row-fluid">
			  <?php include('student_sidebar.php'); ?>
                ...
                <div class="span9" id="content">
					...
					<?php $query = $conn->query("select * from teacher_class_student
					...
					$query_yes_read = $conn->query("select * from notification_read where notification_id = '$id' and student_id = '$session_id'")or die(mysql_error());
