   <div class="row-fluid">
       <a href="students.php" class="btn btn-info"><i class="icon-plus-sign icon-large"></i> Add Student</a>
                        ...
                        <div class="block">
							...
							<?php
							$query = $conn->query("select * from student LEFT JOIN class ON class.class_id = student.class_id where student_id = '$get_id'");
							...
							?>
								...
								<form method="post">
                                        ...
                                        <div class="control-group">
                                          <div class="controls">
                                            <input  name="email"  value="<?php echo $row['student_email']; ?>" class="input focused" id="focusedInput" type="text" placeholder = "Email Address" required>
                                          </div>
                                        </div>
	      ...
	      <?php
                            if (isset($_POST['update'])) {
							   ...
							   $conn->query("update student set username = '$un' , firstname ='$fn' , lastname = '$ln',student_email='$email', class_id = '$cys',location='../public/uploads/NO-IMAGE-AVAILABLE.jpg' where student_id = '$get_id' ");
